    ...
    var body: some View {
        ...
        if ThemeManager.shared.isOpaqueTheme {
            ...
            VisualEffectBackground(material: material, blendingMode: blendingMode)
                // Keep native blur while softening the contrast of content behind the surface.
                .overlay(AppColors.sidebarBackground.opacity(tintOpacity).allowsHitTesting(false))
        }
    }
}
